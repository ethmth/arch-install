...
if ! [ -e "$LOC/$NAME" ]; then
mkdir -p $LOC/$NAME
mkdir -p $LOC/$NAME/data/blob
mkdir -p $LOC/$NAME/data/block
mkdir -p $LOC/$NAME/data/data
mkdir -p $LOC/$NAME/data/files
mkdir -p $LOC/$NAME/customize
chmod -R 777 $LOC/$NAME/customize
