...
sudo -k virsh -c qemu:///system net-define /home/$CUR_USER/arch-install/files/templates/VPN-Internal.xml
sudo virsh -c qemu:///system net-autostart VPN-Internal
sudo virsh -c qemu:///system net-start VPN-Internal

echo "VPN-Internal should have been successfully defined"
