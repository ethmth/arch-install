...
echo "If you haven't yet, you may want to setup vfio by running the ../vfio/ scripts"
echo "Otherwise, you may want to setup Whonix by running the ../whonix/ scripts."